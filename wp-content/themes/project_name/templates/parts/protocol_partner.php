...
<?php 
$protocol_links = get_field('protocol_links');
$protocol_links_text = get_field('protocol_links_text');
$protocol_page = get_field('protocol_page');
...
<div class="analytics_title">
    ...
    <?php if ($protocol_links) : ?>
        <a class="analytics_links" href="<?php echo esc_url($protocol_links); ?>">
        <?php endif;
        if ($protocol_links_text) : ?>
            <p class="trade"><?php echo ($protocol_links_text); ?></p>
        <?php endif;
        if ($protocol_links) : ?>
        </a>
        <?php endif;?>
        ...
        <?php if($protocol_page):  ?>
            <p class="analytics_page"><?php echo $protocol_page?></p>
        <?php endif ?>
    </div>
    <?php if($title):  ?>
